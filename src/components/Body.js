    ...
    <div className='w-full px-2 md:px-0'>
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        <div className='flex-1'>
          <img src={images['preview_1.jpg']} className='w-full' alt='preview_1' />
        </div>
        <div className='flex-1'>
      ...
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        ...
        <div className='order-1 md:order-2 flex-1'>
          <img src={images['preview_2.jpg']} className='w-full' alt='preview_2' />
        </div>
      </div>
      <div className='border-dashed border-b w-4/5 mx-auto border-main-color'></div>
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        <div className='flex-1'>
          <img src={images['preview_3.jpg']} className='w-full' alt='preview_3' />
        </div>
        <div className='flex-1'>
      ...
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        ...
        <div className='order-1 md:order-2 flex-1'>
          <img src={images['preview_4.jpg']} className='w-full' alt='preview_4' />
        </div>
      </div>
      <div className='border-dashed border-b w-4/5 mx-auto border-main-color'></div>
    </div>
