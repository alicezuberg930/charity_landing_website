...
const HandleBannerBody = ({ selectedBanner }) => {
    ...
    const handleSubmitForm = async (e) => {
        ...
        if (selectedBanner === undefined) {
            create.mutate({ banner }, { onSettled(_) { setIsProcessing(false) } })
        } else {
            update.mutate({ banner, id: selectedBanner._id }, { onSettled(_) { setIsProcessing(false) } })
        }
    }
