    ...
    <div className='mb-6'>
      ...
      <div className='row'>
        <div className='col-sm-12 col-md-12 col-lg-6'>
          ...
          <p>
            <strong className='main-theme'>Điều kiện:</strong> tìm tòi, học hỏi,
            biết vi tính, biết giao tiếp, biết lập kế hoạch, tham gia đầy đủ.
          </p>
        </div>
        <div className='col-sm-12 col-md-12 col-lg-6'>
          <p>
          ...
          <p>
            <strong className='main-theme'>Điều kiện:</strong> tìm tòi, học hỏi,
            biết vi tính, tham gia đầy đủ các chương trình lớn
          </p>
        </div>
      </div>
      ...
      <div className='row'>
        ...
        <div className='col-sm-12 col-md-12 col-lg-6'>
          ...
          <p>
            <strong className='main-theme'>Điều kiện:</strong> tìm tòi, học hỏi,
            giỏi về lập trình website, quản lý tốt tổ website, tham gia nhóm đầy
            đủ.
          </p>
        </div>
      </div>
      ...
      <div className='row'>
        <div className='col-sm-12 col-md-12 col-lg-6'>
          ...
          <ol>
            ...
            <li>
              Triển khai các thông tin (tin nhắn SMS, Email, văn bản …) đến các
              thành viên trong tổ khi nhận thông tin từ Trưởng Nhóm hoặc các Phó
              Nhóm qua: tin nhắn SMS, Email, văn bản
            </li>
            <li>
        ...
        <div className='col-sm-12 col-md-12 col-lg-6'>
          ...
          <ol>
            <li>
              Nhiệm vụ chung các thành viên: đóng tiền (hoặc thêm vật phẩm) đầy
              đủ.
            </li>
            <li>
              Mỗi thành viên đều là người thu thập thông tin để tìm những hoàn
              cảnh gia đình khó khăn (ưu tiên: người già neo đơn, các em nhỏ mồ
              côi).
            </li>
            <li>
              Mỗi thành viên có thể kêu gọi sự đóng góp của người thân trong gia
              đình, bạn bè, đồng nghiệp hay từ nguồn trợ giúp khác.
            </li>
            <li>
              Mục đích nhóm hỗ trợ cụ già neo đơn &amp; trẻ em có hoàn cảnh khó
              khăn.
            </li>
            <li>
