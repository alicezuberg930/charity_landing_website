...
const PostsPage = () => {
  const { FaRegShareSquare, IoIosAddCircleOutline } = icons
      ...
      <div>
        ...
        <div className='space-y-4'>
          <div className='flex lg:flex-row flex-col justify-between gap-2'>
            ...
            <Link to={'/cms/activities/create'} className='flex items-center gap-1 bg-main-color px-4 py-2 rounded-xl text-white'>
