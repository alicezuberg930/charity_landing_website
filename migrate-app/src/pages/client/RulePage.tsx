          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                tháng (quyên góp tiền hoặc kèm theo vật phẩm). Tổng hợp số liệu
                báo cáo tài chính hàng tháng vào ngày 20 tây hàng tháng.
              </li>
              <li>
                Số tiền đi từ thiện tùy thuộc vào từng hoàn cảnh mà Ban Quản Lý
                bàn bạc xem xét. tuỳ thuộc vào nguồn quỹ của nhóm sẽ chọn thời
                gian đi từ thiện.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                cá nhân (họ tên, số điện thoại, địa chỉ email,…) để Trưởng Nhóm
                và Trợ Lý cập nhật danh sách
              </li>
              <li>
                Nếu vì bất kỳ lý do gì không thể tiếp tục hoạt động với nhóm:
                phải gặp mặt các thành viên trong cuộc họp và nêu ra lý do chính
                đáng sẽ được các thành viên đồng ý. Trường hợp sau này nếu đủ
                điều kiện sẽ được hân hoan tiếp đón trở lại. Ngược lại, sẽ không
                được xem xét (thành viên tự ý rút khỏi nhóm).
              </li>
              <li>
              ...
              <li>
                ...
                quà từ thiện. Những thành viên nào sử dụng áo ngoài mục đích từ
                thiện (vụ lợi cá nhân, đi chơi … gây ảnh hưởng đến uy tín của
                Nhóm Ánh Sáng) thì sẽ bị thu lại áo (miễn hoàn tiền) &amp; loại
                bỏ ra khỏi nhóm.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                khăn với các cụ già neo đơn. Phát quà cho học sinh nghèo hiếu
                học tại các trường
              </li>
              <li>
                <strong>Hình thức:</strong> trao trực tiếp bằng tiền và vật phẩm
                (không qua bất kỳ một tổ chức trung gian)
              </li>
              <li>
                Giúp đỡ các đối tượng theo thứ tự sau: Cụ già neo đơn &amp; trẻ
                em bất hạnh có nguy cơ bỏ học.
              </li>
              <li>
                Mọi người đến với nhóm phải bằng cái tâm, biết chia sẻ, thương
                người nghèo khổ và không một ai vì lợi cá nhân. Nếu có sự không
                minh bạch hoặc chia rẽ nhóm sẽ bị loại trừ khỏi nhóm ngay lập
                tức.
              </li>
              <li>
              ...
              <li>
                ...
                ngay cho Trưởng Nhóm và chia sẽ cùng với các thành viên khác để
                tìm cách giúp đỡ
              </li>
              <li>
                Tham gia các buổi họp nhóm, chuyến đi từ thiện cùng với nhóm:Nếu
                thành viên nào bận việc không tham gia được cuộc họp thì nhắn
                tin báo cho Tổ Trưởng, Tổ Trưởng chuyển thông tin lên Trưởng
                Nhóm qua tin nhắn SMS hoặc email.
              </li>
            </ul>
          </div>
        </div>
