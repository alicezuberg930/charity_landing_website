            ...
            <div>
              <div className='mt-4'>
                <div className='text-center'>
                  <span className='text-main-color font-bold text-lg'>{post?.data.title}</span>
              ...
              <div className='mt-4 w-full'>
                <div className='w-fit mx-auto' dangerouslySetInnerHTML={{ __html: post?.data.description! }}></div>
              </div>
              <div className='my-4'>
