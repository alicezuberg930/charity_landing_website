  ...
  return (
    <div className='w-full px-2 md:px-0 mt-20'>
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        <motion.div
          variants={slideLeft({ x: -200, duration: 1 })}
          whileInView="visible"
          initial="invisible"
          className='flex-1'
        >
        ...
        <motion.div
          variants={slideRight({ x: 200, duration: 1 })}
          whileInView="visible"
          initial="invisible"
          className='flex-1'
        >
      ...
      <Separator className='border-dashed border-b border-main-color' />
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        <motion.div
          variants={slideLeft({ x: -200, duration: 1 })}
          whileInView="visible"
        ...
        >
          <LazyLoadImage
            src='./assets/preview/preview_2.jpg'
            className='w-full'
            alt='preview_2'
            effect='blur'
          />
      ...
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        ...
        >
          <LazyLoadImage
            src='./assets/preview/preview_3.jpg'
            className='w-full'
            alt='preview_3'
            effect='blur'
          />
      ...
      <div className='py-5 flex justify-center flex-col md:flex-row items-center'>
        ...
        >
          <LazyLoadImage
            src='./assets/preview/preview_4.jpg'
            className='w-full'
            alt='preview_4'
            effect='blur'
          />
